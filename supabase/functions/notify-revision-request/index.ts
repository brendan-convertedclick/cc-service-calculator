// supabase/functions/notify-revision-request/index.ts
//
// Request:  POST { revision_request_id }
// Response: 200 { notified: string[], chat_ok: boolean }
//
// Best-effort notification fired right after a staff member submits a
// revision request: pings every admin in ClickUp chat (with a real mention)
// and sends them an email. Always fires — revision requests have no
